        ...
        try
        {
            ...
            case 3:
            {
                ...
                if(Choice == 1)
                {
                    ...
                    int strategyChoice;
                     while (true) {
                        std::cout << "Choose the strategy to split students:\n";
                        std::cout << "1. One-container strategy\n";
                        std::cout << "2. Two-container strategy \n";
                        std::cout << "Enter your choice (1 or 2): ";
                        std::cin >> strategyChoice;

                        if (std::cin.fail() || (strategyChoice != 1 && strategyChoice != 2)) {
                            std::cin.clear(); // Clear the error flag
                            std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n'); // Discard invalid input
                            std::cerr << "Invalid input. Please enter a number (1 or 2).\n";
                        } 
                        else if (strategyChoice == 1) 
                        {
                            FileManager::splitStudentsByGrade1(students, "passed_studentsVector.txt", "failed_studentsVector.txt");
                            break;
                        } 
                ...
                else if (Choice == 2)
                {
                    ...
                    int strategyChoice;
                     while (true) {
                        ...
                        {
                            FileManager::splitStudentsByGrade1(students, "passed_studentsList.txt", "failed_studentsList.txt");
                            break;
                        } 
                        else if (strategyChoice == 2)
                        {
                ...
                else if (Choice == 3)
                {
                    ...
                    std::cout << "\nSorting took " << sortTime << " seconds.\n\n";
                     ...
                     while (true) {
                        ...
                        {
                            FileManager::splitStudentsByGrade1(students, "passed_studentsDeque.txt", "failed_studentsDeque.txt");
                            break;
                        } 
                        else if (strategyChoice == 2)
                        {
